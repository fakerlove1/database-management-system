...
![image](picture/872539-20161020123141654-1604480583.png)

举例

 ![image](picture/872539-20161020123142717-1747513796.png)

#### 差

![](picture/872539-20161020123143498-200778541.png)

举例

![](picture/872539-20161020123144342-726634882.png)
...
![](picture/872539-20161020123145154-798312210.png)
...
![](picture/872539-20161020123146732-289507973.png)

举例

> 选择A2值为a或b的元祖

![](picture/872539-20161020123147498-1130626773.png)

![](picture/872539-20161020123148123-905080733.png)
...
![img](picture/20190602171609125.png)

解：**L或N类属性有E和C, LR类属性ADB，令X=EC,(EC)+=U,EC为R的唯一候选码。**

**例3：**

![img](picture/20190602173853623.png)

**例4：**

![img](picture/20190602175111634.png)

**例5：**

![img](picture/20190602175141126.png)
...
![F+](picture/20181125205358907.png)

##### 例题

![题目](picture/20181125205416554.png)
![答案](picture/20181125205432478.png)
...
![属性闭包](picture/20181125205455552.png)
...
![属性闭包例题](picture/2018112520552176.png)
...
- 根据每个分解的属性，构造出初始表
- ![img](picture/211054351402115.png)
- 然后看第一个依赖A->C，找到A对应的第一列，其中1 2 5行的值相等，找到C对应的第三列，对应格子没有a值，所以全部改成b13b13。
- ![img](picture/211056092031146.png)
- 同理看第二个依赖，B->C，把b33b33改成b13b13。
- ![img](picture/211056516099856.png)
- 以此类推
- ![img](picture/211057216409447.png)
- ![img](picture/211057502961728.png)
- ![img](picture/211058348282823.png)
...
![在这里插入图片描述](picture/20200610115456198.png)
...
![在这里插入图片描述](picture/20200610121033947.png)
...
![img](picture/1126979-20180106201315518-249044157.png)
...
![在这里插入图片描述](picture/2020061012072890.png)
**（2）基本 E-R 模型的扩展**
**数据抽象**
一般有 3 种抽象：
(1)分类: 它抽象了对象值和型之间“is member of”的语义。例如：“张英”是“学生”实体中的一员。
![在这里插入图片描述](picture/20200610120502912.png)
(2)聚集 :它抽象了对象内部类型和成分之间“is part of”的语义。例如：若干属性的聚集组成了实体型。

![在这里插入图片描述](picture/20200610120538664.png)
![在这里插入图片描述](picture/20200610120617314.png)
(3)概括 :它抽象了类型之间“is subset of”的语义。
![在这里插入图片描述](picture/20200610120637304.png)
**依赖联系**
...
![在这里插入图片描述](picture/20200610120426133.png)
...
![在这里插入图片描述](picture/20200610121706852.png)
...
![在这里插入图片描述](picture/20200610114618423.png)
...
![在这里插入图片描述](picture/20200610114805270.png)
...
![在这里插入图片描述](picture/2020061011483790.png)
...
职工（工号，姓名，年龄，性别，职称）
亲属（工号，亲属姓名，亲属关系）
![在这里插入图片描述](picture/20200610114930133.png)
...
![在这里插入图片描述](picture/20200610115026486.png)
...
课程（课程号，课程名，学时）
选修（学号，课程号，成绩）
![在这里插入图片描述](picture/20200610115106841.png)
...
零部件（代号，名称，价格）
组装（代号，组装件代号，数量）
![在这里插入图片描述](picture/20200610115129617.png)
...
![在这里插入图片描述](picture/20200610115203139.png)
...
![在这里插入图片描述](picture/202006101202434.png)
...
![在这里插入图片描述](picture/20200610122736344.png)
